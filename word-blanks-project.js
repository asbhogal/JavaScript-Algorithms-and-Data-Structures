function wordBlanks(myNoun, myAdjective, myVerb, myAdverb) {                                // WHEN THE FUNCTION wordBlanks IS CALLED, ACCEPT THE DATA IN THE FOUR STRING VARIABLE PARAMETERS
    ...
    return result;                                                                           // RETURN THE VALUE OF RESULT TO THE INITIAL CALL - THIS OUTPUT IS NEEDED
}

console.log(wordBlanks("dog", "big", "ran", "quickly"));                                    // IN THE CONSOLE LOG, CALL THE CONTENTS RETURNED FROM THE FUNCTION wordBlanks, BY FIRST SENDING IT THESE FOUR STRING VALUES
