...
N.B. USING THE SPREAD OPERATOR IN LINE 11 ENSURES THE ENTIRE CONTENTS OF arr2 WILL BE COPIED WITHOUT THE ORIGINAL ARRAY BEING CHANGED. OMITTING THIS OPERATOR WILL THEREFORE MUTATE IT. (ie. ANY CHANGES TO arrCopy WILL CAUSE SUBSEQUENT CHANGES TO arr2 AS IT'S A SHALLOW COPY)

LINE 11 CAN ALSO BE REPLACED WITH THE FOLLOWING FOR THE SAME RESULT:

  const arrCopy = arr2.slice()
  const arrCopy = Array.from(arr2)
